    ...
    public sealed partial class UniversalRenderer : ScriptableRenderer
    {
        ...
        public override void Setup(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            if (renderPassInputs.requiresMotionVectors)
            {
                ...
                // modify by hgz
                var colorDesctemp = colorDesc;
                colorDesctemp.width = 256;
                colorDesctemp.height = 256;
                RenderingUtils.ReAllocateIfNeeded(ref m_MotionVectorColor, colorDesctemp, FilterMode.Point, TextureWrapMode.Clamp, name: "_MotionVectorTexture");
                ...
                var depthDesctemp = depthDescriptor;
                depthDesctemp.width = 256;
                depthDesctemp.height = 256;
                RenderingUtils.ReAllocateIfNeeded(ref m_MotionVectorDepth, depthDesctemp, FilterMode.Point, TextureWrapMode.Clamp, name: "_MotionVectorDepthTexture");
